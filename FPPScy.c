 ...
 * 	test()
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_Hello) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_pf_6FPPScy_pytest(CYTHON_UNUSED PyObject *__pyx_self) {
  ...
  __pyx_t_1 = __pyx_f_6FPPScy_pytest(0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "FPPScy")) {
      if (unlikely(PyDict_SetItemString(modules, "FPPScy", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
